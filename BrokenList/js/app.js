var MyTaskListApp = function () {// Constructor that runs immediately

    var tasks = [];
    var currentTaskIndex = -1;

    var loadTasks = function() {// inner function of MyTaskListApp()
        if (localStorage) {
    ...
    var syncStorage = function() {// inner function of MyTaskListApp()
        localStorage['tasks'] = JSON.stringify(tasks);
    };

    var displayTasks = function () {// inner function of MyTaskListApp()
    ...
    return {
        ...
        },// end of Json object retruned by MyTaskListApp() constructor;
...
}();// end of MyTaskListApp() Constructor.  Because of () here, it runs immediatley upon loading.
